...
| `vm_facts_default_storage_host`      | :heavy_check_mark:                    | [only needed on `storage`] Inventory name where the vm should store its data.                                                                                                                                                                                                                                                                                     |
...
| `vm_facts_default_hypervisor_host` | :heavy_check_mark:  | [only needed on `hypervisor`] Inventory name where the vm should run on.                                                     |
