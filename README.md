...
| `vm_facts_default_backup_host`             | :heavy_check_mark:       | If defined, Inventory name of the default backup server, used when a VM doesn't specify its own `backup_host`.                         |
| `vm_facts_default_backup_replication_host` | :heavy_check_mark:       | If defined, Inventory name of the default backup replication server, used when a VM doesn't specify its own `backup_replication_host`. |
