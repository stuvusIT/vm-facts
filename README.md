...
| `pull_storage_from`    | :heavy_multiplication_x:                                                                                                                                                                                                                            | This will add a list item to the generated `vm_facts_move_storages` var, consisting of a dict containing the keys `source_storage`, `source_dataset`, `target_storage` and `target_dataset_suffix` needed to move a VM.                                                                                                                                    |
